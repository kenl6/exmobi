...
var Exmobi={
	...
	setStringSession : function(s_key,s_val){
		ExMobiWindow.setStringSession(s_key,s_val);
	},
	getStringSession : function(s_key){
		return ExMobiWindow.getStringSession(s_key);
	},
	...
	close:function(){
		ExMobiWindow.close();//uixml的window对象
		//window.close()   //标准浏览器（系统自带浏览器内核）的window对象
	}, 
